...
const Home = () => {
  ...
  useEffect(() => {
    const unsubscribe = subscribeAutomoveis((allCars) => {
      ...
      const available = allCars.filter(car => car.available).slice(0, 6);
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex gap-4 justify-center animate-fadeIn" style={{ animationDelay: "0.4s" }}>
              <button
                ...
                className="bg-white text-gray-900 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transition-all duration-300 hover:scale-105 shadow-2xl flex items-center gap-2"
              >
                <span>🚗</span>
              ...
              <button
                ...
                className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-gray-900 transition-all duration-300 hover:scale-105 flex items-center gap-2"
              >
                <span>📞</span>
                <span>Contactar</span>
              </button>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-5xl font-black text-gray-900 mb-2">{featuredCars.length}+</div>
            ...
            <>
              ...
              <div className="relative max-w-4xl mx-auto">
                ...
                <div className="relative overflow-hidden rounded-2xl shadow-2xl bg-white">
                  ...
                  >
                    {featuredCars.map((car) => (
                      <div key={car.id} className="min-w-full">
                        <div className="relative bg-gray-50 aspect-[21/9] flex items-center justify-center">
                          {/* Imagem do Carro */}
                          <img
                            ...
                            <div className="flex items-end justify-between text-white">
                              ...
                              <div className="text-right">
                                ...
                                <button
                                  ...
                                  className="bg-white text-gray-900 px-8 py-3 rounded-xl font-bold hover:bg-gray-100 transition-all duration-300"
                                >
                                  Ver Detalhes →
                                </button>
                              </div>
                  ...
                  <button
                    onClick={prevSlide}
                    className="absolute left-6 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-900 p-3 rounded-full shadow-xl hover:scale-110 transition-all duration-300 z-10"
                  >
                  ...
                  <button
                    onClick={nextSlide}
                    className="absolute right-6 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-900 p-3 rounded-full shadow-xl hover:scale-110 transition-all duration-300 z-10"
                  >
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center mt-12">
                <button
                  onClick={() => navigate("/cars")}
                  className="bg-gradient-to-r from-gray-900 to-gray-700 text-white px-10 py-4 rounded-xl font-bold text-lg hover:shadow-2xl hover:shadow-gray-900/50 transition-all duration-300 hover:scale-105 inline-flex items-center gap-3"
                >
                  <span>Ver Todos os Carros</span>
                  <span>→</span>
                </button>
