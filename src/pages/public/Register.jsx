...
const Register = () => {
  ...
  const validate = () => {
    ...
    if (!formData.telefone.trim()) {
      newErrors.telefone = 'Telemóvel é obrigatório';
    } else if (formData.telefone.length !== 9) {
      newErrors.telefone = 'Telemóvel deve ter 9 dígitos';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Fazer login novamente para manter sessão na aba original
